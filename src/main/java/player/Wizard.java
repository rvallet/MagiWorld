...
public class Wizard extends Player {
    ...
    public void basicAttack(Player player){
        System.out.println("\n"+this.getName()+ " utilise "+ this.getBasicAttack() +" et inflige "+ this.getIntelligence()+" dommages.");
    ...
    public void specialAttack(Player player){
        ...
        System.out.println("\n"+this.getName()+ " utilise "+ this.getSpecialAttack() +", "+player.getName()+ " gagne "+ heal+" en vitalité.\n");
