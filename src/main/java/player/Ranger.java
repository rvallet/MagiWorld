...
public class Ranger extends Player {
    ...
    public void basicAttack(Player player){
        System.out.println("\n"+this.getName()+ " utilise "+ this.getBasicAttack() +" et inflige "+ this.getAgility()+" dommages.");
    ...
    public void specialAttack(Player player){
        System.out.println("\n"+this.getName()+ " utilise "+ this.getSpecialAttack() +" et gagne "+ this.getLevel()/2+" points d'agilité.\n");
